...
There aren't any shortcut commands in this game, only the buttons on the screen. 
...
also screenshotted some pictures from online game:
https://doodlejump.io/

used input/output methods from 112 website
